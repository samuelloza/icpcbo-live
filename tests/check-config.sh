...
assert_file "config/setup.d/install/05-desktop-defaults.sh"
assert_file "config/setup.d/install/09-full-install-bootstrap-config.sh"
assert_file "config/setup.d/install/23-update-config.sh"
assert_file "config/setup.d/finalize/10-apt-policy.sh"
assert_file "config/setup.d/prepare/10-initramfs.sh"
...
assert_executable "config/setup.d/install/09-full-install-bootstrap-config.sh"
assert_executable "config/setup.d/install/23-update-config.sh"
